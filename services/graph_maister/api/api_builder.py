...
class Graph_MaisterAPI(BaseAPI):
    ...
    @staticmethod
    def create_graph(self, requestId: int, x: List[float], y: List[float], graphFmt: str, title: str, xlabel: str, ylabel: str, imageFormat: str) -> Future[GraphResult]:
        """Creates graph image in base64 based on parameters"""

    @staticmethod
    def create_graph_date(self, requestId: int, startDate: str, dateFmt: str, y: List[float], graphFmt: str, title: str, xlabel: str, ylabel: str, imageFormat: str) -> Future[GraphResult]:
