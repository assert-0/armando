...
public class GraphMaisterAPI {
    ...
    public static void createGraph(int requestId, List<Double> points,
        String title, String xlabel, String ylabel, String imageFormat)
    {
        Serializable payload = new CreateGraphPayload(requestId, points, title, xlabel, ylabel, imageFormat);
